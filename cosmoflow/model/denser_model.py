...
class denser_model ():
    ...
    def build_model(self):
        ...
        h = BatchNormalization(name = 'bn3')(h)
        h = ReLU(name = 'relu2')(h)
        ...
        h = BatchNormalization(name = 'bn4')(h)
        h = ReLU(name = 'relu3')(h)
        ...
        h = BatchNormalization(name = 'bn5')(h)
        h = ReLU(name = 'relu4')(h)
        ...
        h = BatchNormalization(name = 'bn6')(h)
        h = ReLU(name = 'relu5')(h)
        ...
        h = BatchNormalization(name = 'bn8')(h)
        h = ReLU(name = 'relu7')(h)
